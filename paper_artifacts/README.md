...
| `Observed_Monitoring_Metrics.pdf` | Resource-utilisation, thermal, and power metrics observed during the benchmark experiments across all six platforms, with collection methodology and reliability caveats. |
...
# X: (n_samples, 15) engineered features — see the paper and benchmark code
